...
- **Clean typography** - Uses [Inter](https://fonts.google.com/specimen/Inter) and [Fira Mono](https://fonts.google.com/specimen/Fira+Mono) for clarity and legibility (_not_ Fira Code, because the ligatures are confusing and jarring)
